...
KEYWORDS = ['Управление проектами', 'Блог компании Ростелеком', 'Математика', 'Тестирование IT-систем']
...
for article in articles:
    ...
    for KEYWORDS in hubs:
        href = title['href']
        url = 'https://habr.com' + href
        pprint(f'Дата: {date} - Заголовок: {span_title} - Ссылка: {url}')
